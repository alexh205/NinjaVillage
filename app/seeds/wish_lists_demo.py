...
def seed_wish_lists():
    wish_lists = [{"name": "Wish List", "owner_id": 1}, {
        ...
        "name": "Wish List", "owner_id": 5}, {"name": "Wish List", "owner_id": 6}, {"name": "Wish List", "owner_id": 7}, {
        "name": "Wish List", "owner_id": 8}, {"name": "Wish List", "owner_id": 9}, {"name": "Wish List", "owner_id": 10}]
