...
const SignUpForm = () => {
  ...
  const validate = () => {
    ...
    if (password !== repeatPassword) errors.push('Both passwords must match');
    return errors;
  };
  ...
  const onSignUp = async e => {
    ...
    if (password === repeatPassword) {
      await dispatch(signUp(username, name, email, password, profileImage));
    }
    ...
    <div className="flex flex-col items-center h-screen mt-8">
      <div className="w-[500px] flex flex-col rounded-md border-[1px] border-gray-300 p-[30px] bg-ninja_green">
        ...
        <p className="text-[11px] text-white">
          By creating an account, you agree to NinjaVillage's Conditions of Use
          and Privacy Notice.
        </p>
