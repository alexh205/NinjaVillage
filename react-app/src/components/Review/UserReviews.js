...
const UserReviews = ({ review, product, user }) => {
    ...
    return (
        <div
            className="ml-4 px-3 border-[2px] flex flex-col items-start justify-center"
        ...
        >
            ...
            <div>
                <div className="text-sm mt-1 mb-2 line-clamp-2">
                    {review.review}
                </div>
            </div>
            <div>
